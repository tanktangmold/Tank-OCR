...
func HandleLearnCatalog(w http.ResponseWriter, r *http.Request) {
...
func HandleLearnInterest(w http.ResponseWriter, r *http.Request) {
...
func HandleLearnBooks(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
		return
	}
...
func HandleLearnStory(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		http.Error(w, "Method not allowed", http.StatusMethodNotAllowed)
		return
	}
	id := r.PathValue("id")
	if id == "" {
		id = strings.Trim(strings.TrimPrefix(r.URL.Path, "/api/learn/story/"), "/")
	}
	if id == "" {
